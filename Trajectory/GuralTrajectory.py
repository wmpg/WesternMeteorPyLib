...
class TrajectoryInfo(ct.Structure):
    ...
    _fields_ = [
        ...
        ('camera_LST', ct.POINTER(ct.c_double)),
        ('rcamera_ECI', PPDOUBLE),
        ...
        ('ttzero', ct.c_double),
        ('numparams', ct.c_int),
        ('params', ct.POINTER(ct.c_double)),
        ('limits', ct.POINTER(ct.c_double)),
        ('xguess', ct.POINTER(ct.c_double)),
        ('xshift', ct.POINTER(ct.c_double)),
        ('solution', ct.POINTER(ct.c_double)),
        ('ra_radiant', ct.POINTER(ct.c_double)),
        ('dec_radiant', ct.POINTER(ct.c_double)),
        ('vbegin', ct.POINTER(ct.c_double)),
        ('decel1', ct.POINTER(ct.c_double)),
        ('decel2', ct.POINTER(ct.c_double)),
        ('ra_sigma', ct.POINTER(ct.c_double)),
        ('dec_sigma', ct.POINTER(ct.c_double)),
        ('vbegin_sigma', ct.POINTER(ct.c_double)),
        ('decel1_sigma', ct.POINTER(ct.c_double)),
        ('decel2_sigma', ct.POINTER(ct.c_double)),
        ('max_convergence', ct.POINTER(ct.c_double)),
        ('ra_radiant_IP', ct.POINTER(ct.c_double)),
        ('dec_radiant_IP', ct.POINTER(ct.c_double)),
        ('ra_radiant_IPW', ct.POINTER(ct.c_double)),
        ('dec_radiant_IPW', ct.POINTER(ct.c_double)),
        ('ra_radiant_LMS', ct.POINTER(ct.c_double)),
        ('dec_radiant_LMS', ct.POINTER(ct.c_double)),
        ('dtime_ref', ct.POINTER(ct.c_double)),
        ('dtime_tzero', ct.POINTER(ct.c_double)),
        ('dtime_beg', ct.POINTER(ct.c_double)),
        ('dtime_end', ct.POINTER(ct.c_double)),
        ('tref_offsets', ct.POINTER(ct.c_double)),
        ('meas_lat', PPDOUBLE),
        ('meas_lon', PPDOUBLE),
        ('meas_hkm', PPDOUBLE),
        ('meas_range', PPDOUBLE),
        ...
        ('model_fit2', PPDOUBLE),
        ('model_time', PPDOUBLE),
        ('rbeg_lat', ct.POINTER(ct.c_double)),
        ('rbeg_lon', ct.POINTER(ct.c_double)),
        ('rbeg_hkm', ct.POINTER(ct.c_double)),
        ('rbeg_lat_sigma', ct.POINTER(ct.c_double)),
        ('rbeg_lon_sigma', ct.POINTER(ct.c_double)),
        ('rbeg_hkm_sigma', ct.POINTER(ct.c_double)),
        ('rend_lat', ct.POINTER(ct.c_double)),
        ('rend_lon', ct.POINTER(ct.c_double)),
        ('rend_hkm', ct.POINTER(ct.c_double)),
        ('rend_lat_sigma', ct.POINTER(ct.c_double)),
        ('rend_lon_sigma', ct.POINTER(ct.c_double)),
        ('rend_hkm_sigma', ct.POINTER(ct.c_double))
    ]
