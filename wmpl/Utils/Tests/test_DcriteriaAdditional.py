...
if __name__ == "__main__":
    ...
    test_functions = [
        ...
        test_DX_right_ascension_term_scales_the_chord_not_the_angle,
        ...
        test_tancredi_class_limits_are_half_open,
        test_tancredi_unbound_orbit_is_not_silently_unclassified,
