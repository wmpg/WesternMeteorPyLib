...
from wmpl.Formats.Plates import plateExactMap, plateScaleMap, loadScale, loadExact

from wmpl.Utils.Math import polarToCartesian, cartesianToPolar, rotatePoint, pointInsidePolygon
from wmpl.Utils.GreatCircle import greatCircle, fitGreatCircle
...
if __name__ == "__main__":
    ...
    # Full GigE
    dir_path = os.path.join(os.path.curdir, "..", "MirfitPrepare", "20180611_064832_mir")
