...
def solveTrajectory(meteor_list, output_dir, solver='original'):
    ...
    if meteor_list:
        ...
        if solver == 'original':
            ...
            traj = Trajectory(jdt_ref, output_dir=output_dir, meastype=2, max_toffset=4.0, filter_picks=True, monte_carlo=True)
